		...
		<header>	
			...
			<nav>
				<ul>
					...
					<li><a href="<?php echo $app['url_generator']->generate('methodologie')?>">Méthodologie</a></li>
				...
				<a href="<?php echo $app['url_generator']->generate('inscription')?>">Inscription</a>
				<a href="<?php echo $app['url_generator']->generate('connexion')?>">Connexion</a>					
			</nav>
